...
- Normalized the custom Brave, ChatGPT, GitHub, and YouTube display labels to lowercase so they match automatically discovered application names.

## [1.2.1] - 2026-08-18

### Fixed

- Corrected the panel module and service lookup to use the permanent owned plugin ID.
